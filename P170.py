...
class grade_3():
    ...
    def __init__(self, launguage_arts, mathematics):
        self.launguage_arts = launguage_arts
        self.mathematics = mathematics
        
        
    def percentage(self):
        
        total_marks = self.launguage_arts + self.mathematics
 ...
 class grade_5():
     ...
     def __init__(self, launguage_arts, mathematics, social_studies):
         self.launguage_arts = launguage_arts
         self.mathematics = mathematics
     ...
     def percentage(self):
         ...
         total_marks = self.launguage_arts + self.mathematics + self.social_studies
         total_marks_with_100 = total_marks * 100
        ...
        class grade_10():
            ...
            def __init__(self, launguage_arts, mathematics, social_studies,foreign_language):
                self.launguage_arts = launguage_arts
                self.mathematics = mathematics
                self.launguage_arts = launguage_arts
            ...
            def percentage(self):
                ...
                total_marks = self.launguage_arts + self.mathematics + self.social_studies + self.foreign_language
                total_marks_with_100 = total_marks * 100
...
grade_3_button = Button(root,text="Grade 3",command=object_grade_3.percentage)
grade_3_btn.pack(padx=20,pady=20)
percentage_grade_3_label.pack(padx=20,pady=20)
        

object_grade_5 = grade_3(40,50,90)
grade_5_button = Button(root,text="Grade 5",command=object_grade_5.percentage)
grade_5_btn.pack(padx=20,pady=20)
percentage_grade_5_label.pack(padx=20,pady=20)
        


object_grade_10 = grade_3(40,50,70,90)
grade_10_button = Button(root,text="Grade 10",command=object_grade_10.percentage)
